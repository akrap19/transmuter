...
export const FOUNDER = {
  ...
  ORACLE_MAX_STALENESS_SECS: 120,
  ORACLE_MAX_CONF_BPS: 500,
  SALE_PCT_MIN: 25,
  LP_PCT_MIN: 10,
...
export function readRustConstants() {
  ...
  return {
    ...
    ORACLE_MAX_STALENESS_SECS: rustU64(src, "ORACLE_MAX_STALENESS_SECS"),
    ORACLE_MAX_CONF_BPS: rustU64(src, "ORACLE_MAX_CONF_BPS"),
